...
function testcase() {
  ...
  IndelPlan.patientManagement.groupBox_6.lineEdit_SearchPatient.Keys("testpatient")
  
  const cnt = IndelPlan.patientManagement.treeWidget_PatientList.wItems.Count
  if (strictEqual(cnt, 1)) {
    Log.Checkpoint("Filter patient Name successfully!")
  } else {
    Log.Error("Filter patient Name fail!")
  }
