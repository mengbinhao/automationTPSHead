...
function testcase() {
  ...
  if (study.addOneRegistedStudyActivity(indelPlan, Project.Variables.study_image_id)) {
    ...
    contour.editContourLib(indelPlan, pv, Project.Variables.contourlib_name, Project.Variables.edit_contourlib_name, Project.Variables.edit_contourlib_type, Project.Variables.edit_contourlib_display_mode, false, true)
