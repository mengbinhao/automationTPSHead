...
function testcase() {
  ...
  if (study.addOneRegistedStudyActivity(indelPlan, Project.Variables.study_image_id)) {
    ...
    indelPlan.ContourGUI.groupBox_5.DeleteLayerBefore.ClickButton()
    ...
    Regions.YANGDAZHONG_MR78_contour_skin_delete_before_png.Check(indelPlan.ContourGUI.canvas.C2DViewer.Picture(), false, false, globalConstant.obj.pixelTolerance, globalConstant.obj.colourTolerance)
  } else {
