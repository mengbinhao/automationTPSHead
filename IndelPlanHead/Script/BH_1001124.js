...
function testcase() {
  ...
  if (study.addOneRegistedStudyActivity(indelPlan, Project.Variables.study_image_id)) {
    ...
    indelPlan.ContourGUI.groupBox_5.CopyPrevious.ClickButton()
    
    Regions.YANGDAZHONG_MR78_contour_skin_copy_prev_png.Check(indelPlan.ContourGUI.canvas.C2DViewer.Picture(), false, false, globalConstant.obj.pixelTolerance, globalConstant.obj.colourTolerance)
  } else {
