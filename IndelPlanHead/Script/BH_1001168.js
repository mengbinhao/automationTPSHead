...
function testcase() {
  ...
  if (study.addOneRegistedStudyActivity(indelPlan, Project.Variables.study_image_id)) {
    ...
    if (contour.loadAndContourTargetAreaByBrushActivity(indelPlan, 'tar')) {
      ...
      Regions.YANGDAZHONG_MR78_plan_fine_point_png.Check(indelPlan.PlanGUI.canvas.PlanC2DViewer.Picture(), false, false, globalConstant.obj.pixelTolerance, globalConstant.obj.colourToleranceForPD)
    } else {
